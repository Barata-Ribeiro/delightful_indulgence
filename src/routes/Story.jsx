    ...
    <section className={`${styles.story} container`}>
      ...
      <div className={styles.grid1}>
        ...
        <p className={styles.paragraph1}>
          ...
          <br />
          <br /> Upon graduation, they decided to bring their vision to life and
          established Delightful Indulgence. Starting from a small home kitchen,
          they worked tirelessly to perfect their secret recipes, focusing on
          quality and innovation. They aspired to create not just desserts, but
          experiences - little indulgences to make life&apos;s everyday moments
          more delightful.
        </p>
      </div>
      <div className={styles.grid2}>
        <div className={styles.paragraphs2}>
          <p className={styles.paragraph2}>
            ...
            it&apos;s an anniversary, a quiet date night in, or simply a shared
            moment of indulgence, they aimed to create desserts that make these
